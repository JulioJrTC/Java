 ...
 * @author julio
 */
public class Exercicio11_INTERFACE extends javax.swing.JFrame {

    /**
     * Creates new form Exercicio11_INTERFACE
     */
    public Exercicio11_INTERFACE() {
        initComponents();
    }
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        //Criando um novo objeto a partir da classe criada anteriormente
        Exercicio11_CLASSE obj = new Exercicio11_CLASSE();
        
        //Mensangens de erros
        String erro1 = "Erro! Digite um valor para a altura (usando ponto como separador caso necessario)";
        String erro2 = "Erro! Digite um valor para a largura (usando ponto como separador caso necessario)";
        
        //Mecanica de erro
        try{
            //Atribuindo ao atributo da altura um valor (convertido) de uma caixa de texto
            obj.setAltura(Double.parseDouble(txtAltura.getText()));            
        ...
        //Mecanica de erro
        try{
            //Atribuindo ao atributo da largura um valor (convertido) de uma caixa de texto
            obj.setLargura(Double.parseDouble(txtLargura.getText()));
        }catch(NumberFormatException erroLargura){
            JOptionPane.showMessageDialog(null, erro2);
            return;
        }
        
        //Chamandos dos metodos criados na classe
        obj.calcularArea();
        obj.calcularTinta();
        
        //Inserindo as caixas de texto os valores calculados nos metodos acima
        txtArea.setText(String.valueOf(obj.getArea()));
        txtFieldTinta.setText(String.format("Em uma area de %.2f(m²), %nSerá necessario %.2f(l) de tinta.",obj.getArea(),obj.getQuantTinta()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exercicio11_INTERFACE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exercicio11_INTERFACE().setVisible(true);
            }
        });
    }
